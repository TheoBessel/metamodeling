...
/**
 * Entry point of the 'ToND' generation module.
 *
 * @generated
 */
public class ToND extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/acceleo/petrinet/toND/toND";
     ...
     * @generated
     */
    public static final String[] TEMPLATE_NAMES = { "petrinetToND" };
     ...
     * @generated
     */
    public ToND(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public ToND(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                ToND generator = new ToND(modelURI, folder, arguments);
