...
public class PetrinetPackageImpl extends EPackageImpl implements PetrinetPackage {
	 ...
	 */
	@Override
	public EReference getPetriNetwork_Arcs() {
	 ...
	 */
	@Override
	public EReference getPetriNetwork_Transitions() {
		return (EReference) petriNetworkEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EReference getPetriNetwork_Places() {
		return (EReference) petriNetworkEClass.getEStructuralFeatures().get(3);
	}
	...
	public void createPackageContents() {
		...
		createEReference(petriNetworkEClass, PETRI_NETWORK__ARCS);
		createEReference(petriNetworkEClass, PETRI_NETWORK__TRANSITIONS);
		createEReference(petriNetworkEClass, PETRI_NETWORK__PLACES);

		transitionEClass = createEClass(TRANSITION);
		createEReference(transitionEClass, TRANSITION__PETRI_NET);
		...
		createEReference(placeEClass, PLACE__PETRI_NET);
	...
	public void initializePackageContents() {
		...
		initEReference(getPetriNetwork_Arcs(), this.getArc(), this.getArc_PetriNet(), "arcs", null, 0, -1,
				PetriNetwork.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPetriNetwork_Transitions(), this.getTransition(), this.getTransition_PetriNet(),
				"transitions", null, 0, -1, PetriNetwork.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPetriNetwork_Places(), this.getPlace(), this.getPlace_PetriNet(), "places", null, 0, -1,
				PetriNetwork.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(transitionEClass, Transition.class, "Transition", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTransition_PetriNet(), this.getPetriNetwork(), this.getPetriNetwork_Transitions(), "petriNet",
		...
		initEAttribute(getTransition_Name(), ecorePackage.getEString(), "name", null, 1, 1, Transition.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTransition_Arcs(), this.getArc(), this.getArc_Transition(), "arcs", null, 2, -1,
				Transition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(arcEClass, Arc.class, "Arc", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getArc_Weight(), ecorePackage.getEInt(), "weight", "1", 1, 1, Arc.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getArc_Kind(), this.getArcKind(), "kind", null, 1, 1, Arc.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getArc_Direction(), this.getArcDirection(), "direction", null, 1, 1, Arc.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getArc_Transition(), this.getTransition(), this.getTransition_Arcs(), "transition", null, 1, 1,
		...
		initEReference(getArc_Place(), this.getPlace(), null, "place", null, 1, 1, Arc.class, !IS_TRANSIENT,
				...
				IS_ORDERED);
		initEReference(getArc_PetriNet(), this.getPetriNetwork(), this.getPetriNetwork_Arcs(), "petriNet", null, 1, 1,
				Arc.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getPlace_Name(), ecorePackage.getEString(), "name", null, 1, 1, Place.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPlace_Marking(), ecorePackage.getEInt(), "marking", null, 1, 1, Place.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPlace_PetriNet(), this.getPetriNetwork(), this.getPetriNetwork_Places(), "petriNet", null, 1,
				1, Place.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
