...
public class PlaceItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						PetrinetPackage.Literals.PLACE__NAME, true, false, false,
	...
	protected void addMarkingPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Place_marking_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Place_marking_feature", "_UI_Place_type"),
						PetrinetPackage.Literals.PLACE__MARKING, true, false, false,
