...
public class PetrinetAdapterFactory extends AdapterFactoryImpl {
	...
	protected PetrinetSwitch<Adapter> modelSwitch = new PetrinetSwitch<Adapter>() {
		@Override
		public Adapter casePetriNetwork(PetriNetwork object) {
			return createPetriNetworkAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link petrinet.PetriNetwork <em>Petri Network</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createPetriNetworkAdapter() {
		return null;
	}
