...
public class PetrinetSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case PetrinetPackage.PETRI_NETWORK: {
			PetriNetwork petriNetwork = (PetriNetwork) theEObject;
			T result = casePetriNetwork(petriNetwork);
			if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Petri Network</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Petri Network</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePetriNetwork(PetriNetwork object) {
		return null;
	}
