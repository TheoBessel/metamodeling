...
public class SimplepdlPackageImpl extends EPackageImpl implements SimplepdlPackage {
	...
	public EAttribute getACResource_ResourceQuantity() {
		return (EAttribute)acResourceEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getACResource_WorkDefinition() {
		return (EReference)acResourceEClass.getEStructuralFeatures().get(1);
	}
	...
	public EReference getACResource_Resource() {
		return (EReference)acResourceEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEReference(acResourceEClass, AC_RESOURCE__WORK_DEFINITION);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getProcess_Name(), ecorePackage.getEString(), "name", "process", 1, 1, simplepdl.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getGuidance_Text(), ecorePackage.getEString(), "text", "guidance", 1, 1, Guidance.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getWorkDefinition_Name(), ecorePackage.getEString(), "name", "workDefinition", 1, 1, WorkDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getWorkDefinition_Resources(), this.getACResource(), this.getACResource_WorkDefinition(), "resources", null, 0, -1, WorkDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getResource_Name(), ecorePackage.getEString(), "name", "resource", 1, 1, Resource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getACResource_ResourceQuantity(), ecorePackage.getEInt(), "resourceQuantity", null, 1, 1, ACResource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getACResource_WorkDefinition(), this.getWorkDefinition(), this.getWorkDefinition_Resources(), "workDefinition", null, 1, 1, ACResource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getACResource_Resource(), this.getResource(), null, "resource", null, 1, 1, ACResource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
