 ...
 *   <li>{@link simplepdl.WorkDefinition#getResources <em>Resources</em>}</li>
 * </ul>
 *
...
public interface WorkDefinition extends ProcessElement {
	 ...
	 * The list contents are of type {@link simplepdl.ACResource}.
	 * It is bidirectional and its opposite is '{@link simplepdl.ACResource#getWorkDefinition <em>Work Definition</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Resources</em>' containment reference list.
	 * @see simplepdl.SimplepdlPackage#getWorkDefinition_Resources()
